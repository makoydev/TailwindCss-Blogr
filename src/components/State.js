...
const State = () => {
    return (
        <>
            ...
            <div >
                    <div><img className="state-img circles" src={circles} alt="" /></div>
                    <div><img className="state-img" src={phones} alt="" /></div>
                </div>
                
                
                
                <div className="pt-80 px-5 md:py-20">
                <h2 className="text-center text-3xl lg:text-4xl 2xl:text-5xl mb-5 text-white md:text-left" >
