    ...
    return (
        <>
            <section className="py-20 px-5">
                ...
                <div className="flex flex-col-reverse text-center md:grid md:grid-cols-2 md:gap-5 md:items-center md:text-left xl:max-w-5xl xl:mx-auto">
                  ...
                  <div>
                      <picture>
                          ...
                          <img className="w-full block mx-auto mt-10" src={mobileImage} alt="" />
                      </picture> 
                  </div>
                </div>
            </section>
